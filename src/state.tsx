...
const useEnemyStore = create<EnemyStore>()((set, get) => ({
  ...
  createEnemies: (n: number, donutThreshold: number) => set((state) => ({...state, enemies: constructEnemies(n, donutThreshold)})),
  setEnemies: (enemies: EnemyObject[]) => set((state) => ({...state, enemies: enemies})),
